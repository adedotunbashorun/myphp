...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 13, 2016 at 08:39 AM
...
CREATE TABLE IF NOT EXISTS `course` (
  ...
  `courseduration` varchar(60) NOT NULL
...
CREATE TABLE IF NOT EXISTS `department` (
  ...
  `quota` int(3) NOT NULL DEFAULT '3'
...
INSERT INTO `department` (`id`, `title`, `abbrev`, `slug`, `faculty`, `quota`) VALUES
(1, 'Computer Science', 'CS', 'comp-sci', 1, 10),
(2, 'Hospitality Management', 'HLTM', 'hltm', 1, 10),
(3, 'Mass Communication', 'MC', 'mc', 1, 10),
(4, 'Nutrition & Dietetics', 'NUD', 'nud', 1, 10),
(5, 'Science Laboratory Technology', 'SLT', 'slt', 1, 10),
(6, 'Maths & Statistics', 'MS', 'ms', 1, 10),
(7, 'Accountancy', 'ACC', 'acc', 2, 10),
(8, 'Banking & Finance', 'BFN', 'bfn', 2, 10),
(9, 'Business Studies', 'BAM', 'bam', 2, 10),
(10, 'Marketing', 'MKT', 'mkt', 2, 10),
(11, 'Public Administration', 'PAD', 'pad', 2, 10),
(12, 'Office Technology Management', 'OTM', 'otm', 2, 10),
(13, 'Architectural Technology', 'ARC', 'arc', 3, 10),
(14, 'Building Technology', 'BLD', 'BLD', 3, 10),
(15, 'Estate Management', 'EST', 'est', 3, 10),
(16, 'Quantity Surveying', 'QS', 'qs', 3, 10),
(17, 'Surveying & Geo-Informatics', 'SGI', 'sgi', 3, 10),
(18, 'Urban & Regional Planning', 'URP', 'urp', 3, 10),
(19, 'Agricultural Engineering', 'AGE', 'age', 4, 10),
(20, 'Chemical Engineering', 'CHE', 'che', 4, 10),
(21, 'Civil Engineering', 'CVE', 'cve', 4, 10),
(22, 'Electrical & Electronics Engineering', 'EEC', 'eec', 4, 10),
(23, 'Mechanical Engineering', 'MEC', 'mec', 4, 10);
...
CREATE TABLE IF NOT EXISTS `post` (
  ...
  `callupno` varchar(32) NOT NULL,
  `areaposted` varchar(100) NOT NULL
...
INSERT INTO `post` (`id`, `user_id`, `name`, `callupno`, `areaposted`) VALUES
(5, 1, '', '---call up no----', '0'),
(6, 1, 'fgg', '', '1');
...
CREATE TABLE IF NOT EXISTS `register` (
  ...
  `schoolstate` int(2) NOT NULL,
  `callup` varchar(32) NOT NULL
...
INSERT INTO `register` (`id`, `action`, `matric`, `name`, `address`, `gender`, `dob`, `mstatus`, `phone`, `origin`, `email`, `religion`, `nationality`, `local`, `extra`, `status`, `qualification`, `institution`, `service`, `dept`, `schoolstate`, `callup`) VALUES
(2, 1, '1', '', '', 0, '', 0, '', 0, '', 0, 'nigeria', 0, '', '', '', '', '', '0', 0, ''),
(3, 1, '2', '', '', 0, '', 0, '', 0, '', 0, 'nigeria', 0, '', '', '', '', '', '0', 0, '');
