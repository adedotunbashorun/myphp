...
include("inc/auth.php");
	...
	if($c>=1){
		$trow="<option>---form no----</option>";
	while($rs=mysqli_fetch_array($sql)){
		//$_SESSION['name']=$rs['name'];
		$id=$rs['id'];
		$trow.="<option value='".$rs['matric']."'>".$rs['matric']."</option>";
	...
	if(isset($_POST["submit"])){
		...
		$call=$_POST['callup'];
		$state=$_POST['state'];
		$sql=mysqli_query($con,"INSERT INTO post(user_id, name, callupno, areaposted) VALUES ('$id','$name','$call','$state') ") OR die("QNS"); 
	 	...
	 	<div class="row">
	 		<div class="col-lg-8">
	 			...
	 			<div class="panel-heading"> 
	 				<h3 class="panel-title"><span class="glyphicon glyphicon-user">&nbsp;&nbsp;</span>Diagnose Patient</h3> 
	 			<?php if(isset($msg)) echo $msg; ?></div>
	 			 <div class="panel-body">
		 			<form role="form" method="post" action="">
					  
					  <div class="form-group col-lg-12">
					      <select class="form-control" name="callup" >
					  ...
					  <div class="form-group col-lg-9">
					     <?php echo populateSelect('course','state','form-control', '---select disease--', ''); ?>
					  </div>
