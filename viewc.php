...
include("inc/auth.php");
	...
	$sql=mysqli_query($con,"SELECT * FROM course") Or die("QNS");
	$c=mysqli_num_rows($sql);
	if($c>=1){
		$sn=1;
		$trow="<table style='width:90%;font-size:1.2em;' class='table table-striped table-hover table-bordered'><thead><tr><th>S/N</th><th>Disease Name</th><th>Disease Symptoms</th></tr></thead>";
	while($rs=mysqli_fetch_array($sql)){
		//$id=$rs['user_id'];
			
			$trow.="<tbody><tr><td>".$sn."</td><td>".$rs['coursename']."</td><td>".$rs['courseduration']."</td></tr></tbody>";
			$sn++;
		}
		$trow.="</table>";
}
	 	...
	 	<div class="row">
	 		<div class="col-lg-8">
	 			...
	 			<div class="panel-heading"> 
	 				<h3 class="panel-title"><span class="glyphicon glyphicon-user">&nbsp;&nbsp;</span>View Disease Symptoms</h3> 
