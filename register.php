...
include("inc/auth.php");
	...
	if(isset($_POST["submit"])){
		...
		$call=$_POST['callup'];
		$sql=mysqli_query($con,"INSERT INTO register(matric, name, address, gender, dob, mstatus, phone, origin, email, religion, nationality, local, extra, status, qualification, institution, service, callup) VALUES ('$mat','$name','$add','$gen','$dob','$ms','$pn','$or','$em','$re','$nat','$local','$ext','$hs','$qua','$ins','$ser','$call')") OR die("QNS"); 
	}
?>
<!DOCTYPE html>
<html>
	 	...
	 	<div class="row">
	 		<div class="col-lg-12">
	 			...
	 			<div class="panel-heading"> 
	 				<h3 class="panel-title"><span class="glyphicon glyphicon-user">&nbsp;&nbsp;</span>Patient Registration</h3> 
